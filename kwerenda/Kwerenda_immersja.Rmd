...
df <- data.frame(
  ...
  Tytul = c(
    ...
    "Gathering Self-Report Data in Games Through NPC Dialogues",
    "Advancing Psychological Research: A Controlled Virtual Reality Environment",
    "Digitalising qualitative social research? Virtual reality serious game",
    "Role-Playing Games as an Assessment Strategy for Social Skills",
    "The effects of role-playing high gender identification on the California psychological inventory",
  ...
  Autorzy = c(
    ...
    "Daniel Gredig, Daniele Bigoni, Jasmina Bogdanovic, Patrick Weber, Safak Korkut",
...
colnames(df)[5] <- "Abstrakt i Wnioski"

kable(df, "latex", booktabs = TRUE, longtable = TRUE, caption = "Tabela artykułów RPG i Psychologia", escape=FALSE) %>%
  kable_styling(latex_options = c("repeat_header", "hold_position", "scale_down"), font_size = 9, stripe_color = "gray!15") %>%
  column_spec(2, width = "5cm", latex_valign = "p", extra_css = "text-align:justify;") %>%
  column_spec(3, width = "4.5cm", latex_valign = "p", extra_css = "text-align:justify;") %>%
  column_spec(4, width = "5cm", latex_valign = "p", extra_css = "text-align:justify;") %>%
  column_spec(5, width = "9cm", latex_valign = "p", extra_css = "text-align:justify;")
```
